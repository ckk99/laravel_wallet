...
return [
    ...
    'wallet_model' => \App\Models\Wallet::class, // Define the wallet model
    'transaction_model' => \App\Models\WalletTransaction::class,
    'log_model' => \App\Models\WalletLog::class,
    'prefix' => 'WALLET_', // Set a prefix for wallet identifiers
];
